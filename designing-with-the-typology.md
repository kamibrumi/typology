...
With this typology designers can construct representations of decision-making problems, reason about their structure (e.g., loops, interdependencies between decisions, etc.) and carry that structure into interface design.

Designing with the typology is split into problem formulation and design construction:
...
## Design Construction
### Step 4a: Map decisions to Interface Components/Visualizations
### Step 4b: Translate connections between decisions into connection between views
### Step 6: Reflection